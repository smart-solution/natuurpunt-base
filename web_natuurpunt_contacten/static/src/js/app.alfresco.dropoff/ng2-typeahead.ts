import { Component, Input, Output, EventEmitter, ViewChild, OnInit, forwardRef, AfterViewInit } from '@angular/core';
...
export class Typeahead implements OnInit, ControlValueAccessor, AfterViewInit {
  abstract;
