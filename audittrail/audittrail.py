                ...
                if field_obj._type in ('one2many','many2many'):
                    ...
                    if self.check_rules(cr, SUPERUSER_ID, field_obj._obj, method):
                        ...
                        if model.model == x2m_model.model:
                            ...
                            args['resource_id'] = resource_id if not 'resource_id' in args else args['resource_id']
                            if not(field in args) and resource_id == args['resource_id']:
            ...
            if field_obj._type in ('one2many','many2many'):
                ...
                if self.check_rules(cr, SUPERUSER_ID, field_obj._obj, method):
                    ...
                    if model.model == x2m_model.model:
                        ...
                        args['resource_id'] = resource_id if not 'resource_id' in args else args['resource_id']
                        if not(field_name in args) and resource_id == args['resource_id']:
